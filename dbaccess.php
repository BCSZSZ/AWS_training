<?php
$dsn = 'mysql:host=lwrdbaz1a.crqmemsomjjy.ap-northeast-1.rds.amazonaws.com;dbname=lwrdatabaseaz1a';
$username = 'BC_SZSZ2';
$password = 'zkd19950318';
...
<?php foreach ($rec as $a):?>
        <?=escape1($a)?><br>
<?php endforeach; ?>
Add comment by izenn ryou
add comment again by izenn
</body>
</html>
